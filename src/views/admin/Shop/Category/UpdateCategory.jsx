...
export default function UpdateCategory() {
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            try {
                const response = await axios.get(`http://localhost:8080/api/smartstore/category/${id}`);
    ...
    // function for update category and navigate to categories CRUD
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:8080/api/smartstore/category/${id}`, updatedCategory, {
                headers: {
