...
// import from utils
import { exportCategoryToExcel } from '../../utils/export/exportUtilsCategories';
import { exporCategoryTotPdf } from '../../utils/export/exportUtilsCategories';

export default function AddPrintView({ data }) {

    // handle for export as excel
    const handleExportExcel = () => {
        exportCategoryToExcel(data, 'Data Categories Smartstore Home');
        console.log("Download data categories as excel file is successful");
    };

    // handle for export as pdf
    const handleExportPdf = () => {
        exporCategoryTotPdf(data, 'Data Categories Smartstore Home');
        console.log("Download data categories as PDF file is successful");
    };
            ...
            <div className='p-4'>
                <div className="py-3 md:pb-0 grid gap-4 lg:gap-6 xl:gap-6 xl:flex">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
                            <Link to='/categories/add-category' className="no-underline align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium focus:outline-none px-4 py-2 rounded-lg text-sm text-white bg-emerald-500 border border-transparent active:bg-emerald-600 hover:bg-emerald-600 w-full rounded-md h-12" type="button">
                                <span className="mr-2">
                                    <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
