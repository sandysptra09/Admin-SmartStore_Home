...
export default function PaginationCustomer({ currentPage, totalPages, onPageChange }) {

    // create array of pages from 1 to totalPages
    const pages = Array.from({ length: totalPages }, (_, i) => i + 1)

    return (
        <div className="px-4 py-3 border-t border-neutral-200 dark:border-neutral-300 bg-white text-gray-500 dark:text-gray-400 dark:bg-neutral-200">
