...
import "./ComponentsOrders.css";
import PaginationOrder from "./PaginationOrder";

export default function OrdersTableCRUD() {
    return (
                    ...
                    <tbody className="bg-white dark:bg-white text-gray-800 dark:text-gray-400">
                        <tr>
                            ...
                            <td className="px-4 py-2 text-xs ">
                                <span>
                                    <span className="inline-flex px-2 text-xs font-medium leading-5 rounded-full text-blue-500 bg-blue-100 dark:blue-500 dark:bg-blue-100">
                                        Processing
                                    </span>
                                </span>
                            </td>
                            <td className="px-4 py-2 text-center">
                                <select className="block w-full h-12 border bg-gray-100 px-2 py-1 text-sm dark:text-neutral-700 focus:outline-none rounded-md form-select focus:bg-white dark:focus:bg-white focus:border-neutral-200 border-neutral-200 dark:border-neutral-200 focus:shadow-none dark:focus:neutral-400 dark:bg-neutral-200 leading-5 h-8">
